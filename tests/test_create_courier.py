...
class TestCreateCourier:
    def test_create_courier_success(self, courier_client, new_courier_data):
    ...
    def test_create_courier_duplicate_shows_error(self, courier_client, new_courier_data):
